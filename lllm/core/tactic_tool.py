...
def tactictool(
    ...
    *,
    ...
    tactic class or Python method name. A tactic URL can select a specific
...
def resolve_resource_node(
    ...
    *,
    ...
    Supported forms:
    - ``pkg.section:name`` exact full URL
    ...
    *,
    ...
    if len(functions) > 1:
        raise ValueError(
            ...
            "Function tool and a tactic tool. Use a full URL such as "
...
def get_tactic_tool_spec(
    ...
    *,
    ...
    """Resolve a tactic URL and infer the metadata needed for tool exposure."""
    runtime = runtime or get_default_runtime()
