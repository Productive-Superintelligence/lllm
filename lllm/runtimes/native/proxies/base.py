...
from ..core.runtime import Registry, Runtime, _select_runtime
...
class BaseProxy:
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self._runtime = _select_runtime(runtime=runtime, registry=registry)
    ...
    def tactic_endpoint(
        ...
        *,
        ...
        """Create a proxy endpoint backed by a tactic resource ref."""
        from ..core.tactic_tool import sanitize_tool_name

        tactic_ref = tactic_ref or tactic_url
        if tactic_ref is None:
            raise TypeError("tactic_endpoint() requires a tactic_ref.")

        endpoint_name = endpoint or sanitize_tool_name(tactic_ref)
        ...
        _call_tactic_endpoint.endpoint_info = {
            ...
            "description": description or f"Run tactic {tactic_ref}.",
            "sub_category": None,
            "remove_keys": None,
            "params": {},
    ...
    def register_tactic(
        ...
        *,
        ...
        tactic_ref = tactic_ref or tactic_url
        if tactic_ref is None:
            raise TypeError("register_tactic() requires a tactic_ref.")

        attr_name = sanitize_tool_name(endpoint or name or tactic_ref)
    ...
    def _materialize_endpoint_info(
        ...
        return build_tactic_endpoint_info(
            tactic_meta.get("tactic_ref") or tactic_meta["tactic_url"],
            runtime=getattr(self, "_runtime", None),
            base_namespace=getattr(self, "_resource_namespace", None),
...
def register_proxy(
    ...
    *,
    ...
    _select_runtime(runtime=runtime, registry=registry).register_proxy(
        name, proxy_cls, overwrite
    )
